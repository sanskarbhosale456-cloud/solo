...
export const SHOP_ITEMS = [
  {
    key: 'merch_tshirt',
    name: 'Hunter White Tee',
    description: 'Clean minimalist white cotton t-shirt.',
  ...
  {
    key: 'merch_bottle',
    name: 'Void Water Bottle',
    description: 'Matte black insulated hydration bottle.',
    currencyType: 'gold' as const,
    cost: 900,
    category: 'merch',
  ...
  },
  {
    ...
    description: 'Durable multi-pocket navy backpack.',
    currencyType: 'gold' as const,
    cost: 1800,
    category: 'merch',
  ...
  },
  {
    ...
    description: 'Premium heavyweight black hoodie.',
    currencyType: 'gold' as const,
    cost: 3150,
    category: 'merch',
  ...
  },
  {
    ...
    description: 'Fiery glowing aura graphic for your collection.',
    currencyType: 'mana_crystals' as const,
    cost: 300,
    category: 'design_skin',
    image: '/icons/vitality.jpg',
  },
  {
    key: 'skin_void',
    name: 'Void Spectral Skin',
    description: 'Deep purple cosmic nebula skin graphic.',
    currencyType: 'mana_crystals' as const,
    cost: 600,
    category: 'design_skin',
    image: '/icons/intellect.jpg',
  },
  {
    key: 'skin_gold',
    name: 'Golden Monarch Skin',
    description: 'Radiant golden sovereign armor graphic.',
    currencyType: 'mana_crystals' as const,
    cost: 1050,
    category: 'design_skin',
    image: '/icons/strength.jpg',
  },
  {
    key: 'skin_cyber',
    name: 'Neon Cyber Skin',
    description: 'Electric blue matrix circuit graphic.',
    currencyType: 'mana_crystals' as const,
    cost: 1500,
    category: 'design_skin',
    image: '/icons/agility.jpg',
  },
] as const
