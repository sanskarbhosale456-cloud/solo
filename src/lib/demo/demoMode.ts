...
export const INITIAL_DEMO_QUESTS: Quest[] = [
  ...
  },
  {
    id: 'sq-2',
    user_id: 'demo-user',
    title: 'Sprint 5km under 25 minutes',
    description: null,
    type: 'side',
    discipline: 'agility',
    difficulty: 'B',
  ...
  },
  {
    ...
    description: 'Main quest: Expand your mind to see what others cannot.',
    type: 'main',
...
export const DEMO_SOLDIERS: ShadowSoldier[] = [
  { id: 'ds-1', user_id: 'demo-user', soldier_key: 'soldier_01', unlocked_at: new Date(Date.now() - 6*86400000).toISOString() },
]
